...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBJWXgWKNWaGIroL5uT07u6Unmw0FMQ9OL3U2LuaYK1T3lfYWZcv2VtzqsQOAw9kchuoawE3rEpHu2uzPtSVsQPkBE2R4ys=
::YB416Ek+ZG8=
::
::
...
if exist "%file_path%" (
    ...
    REM Essaye de rendre le fichier visible (enlever les attributs caché et système)
    ...
    if %errorlevel%==0 (
        echo [OK] Le fichier python.txt est maintenant visible.
    ) else (
