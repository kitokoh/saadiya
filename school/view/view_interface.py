...
class ViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            sourcePath='https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/view/list_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/view/table_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            widget=frame,
            sourcePath='https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/view/tree_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            widget=w,
            sourcePath='https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/view/flip_view/demo.py'
        )
