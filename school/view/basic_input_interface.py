...
class BasicInputInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/check_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            comboBox,
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/combo_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            HyperlinkButton(
                'https://.com', 'GitHub', self, FluentIcon.LINK),
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            radioWidget,
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/radio_button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            slider,
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/slider/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.switchButton,
            'https://nouractu.com//PyQt-Fluent-Widgets/blob/master/examples/basic_input/switch_button/demo.py'
        )
