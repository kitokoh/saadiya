...
class DateTimeInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            sourcePath='https://nouractu.com/PyQt-Fluent-Widgets/blob/master/examples/date_time/calendar_picker/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://nouractu.com/PyQt-Fluent-Widgets/blob/master/examples/date_time/time_picker/demo.py'
        )
