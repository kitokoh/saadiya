...
class StatusInfoInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/status_info/state_tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/status_info/tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            w,
            'https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/status_info/info_bar/demo.py'
        )
        ...
        card = self.addExampleCard(
            ...
            bar,
            'https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/status_info/progress_bar/demo.py',
        )
        ...
        self.addExampleCard(
            ...
            ring,
            'https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/status_info/progress_ring/demo.py',
        )
