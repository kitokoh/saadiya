...
class BannerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.galleryLabel = QLabel('SCHOOL OF ENTREPRİSE', self)
        ...
        self.linkCardView.addCard(
            ...
            self.tr('NOVA BOOST  '),
            self.tr(
                'Marketing Automation . The latest fluent design controls and strategie for your Markteting.'),
            REPO_URL
        )

        self.linkCardView.addCard(
            FluentIcon.CODE,
            self.tr('MANAGEMENT360'),
            self.tr(
