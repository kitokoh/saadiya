...
class TextInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            widget=lineEdit,
            sourcePath='https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/text/line_edit/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            widget=SpinBox(self),
            sourcePath='https://.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/text/spin_box/demo.py'
        )
