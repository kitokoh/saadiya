...
class NavigationViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            widget=breadcrumb,
            sourcePath='https://.com/navigation/breadcrumb_bar/demo.py',
            stretch=1
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://.com/navigation/pivot/demo.py'
        )

        self.addExampleCard(
            title=self.tr('A segmented control'),
            widget=SegmentedInterface(self),
            sourcePath='https://.com/navigation/segmented_widget/demo.py'
        )

        self.addExampleCard(
            title=self.tr('Another segmented control'),
            widget=self.createToggleToolWidget(),
            sourcePath='https://.com/navigation/segmented_tool_widget/demo.py'
        )

        card = self.addExampleCard(
            title=self.tr('A tab bar'),
            widget=TabInterface(self),
            sourcePath='https://.com/navigation/tab_view/demo.py',
            stretch=1
        )
