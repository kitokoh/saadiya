...
class AddMedia(QWidget):
    ...
    def load_json(self):
        ...
        self.json_file = os.path.join(os.path.expanduser('~'), 'Downloads', 'AI-SNAP-Robot', 'text', 'text1', 'data.json')
    ...
    def add_media(self):
        ...
        if files:
            ...
            self.media_folder = os.path.join(os.path.expanduser('~'), 'Downloads', 'AI-SNAP-Robot', 'media', 'media1')
