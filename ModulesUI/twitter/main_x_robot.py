...
from ModulesUI.twitter.media_manager import MediaTable
from ModulesUI.twitter.group_manager import GroupTable
from ModulesUI.twitter.instances_table import InstanceTable
#from fb_robot_install import FbRobot
...
class XMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI X ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/promotion-icon-png-3422.png'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Twitter Robot Pro", subtitle="Analytics Overview")
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de X Robot ? Cela retirera toutes vos instances."),
