...
class InstaMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI Instagram ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/instagram-icon-956.png'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Insta Robot Pro", subtitle="Analytics Overview")
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de Instagram Robot ? Cela retirera toutes vos instances."),
