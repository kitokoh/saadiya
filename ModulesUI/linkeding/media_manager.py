...
class AddMedia(QWidget):
    ...
    def load_json(self):
        ...
        self.json_file = os.path.join(os.path.expanduser('~'), 'Downloads', 'AI-Lin-Robot', 'text', 'text1', 'data.json')
    ...
    def add_media(self):
        ...
        if files:
            ...
            self.media_folder = os.path.join(os.path.expanduser('~'), 'Downloads', 'AI-Lin-Robot', 'media', 'media1')
...
# Lancer le transfert de fichiers
    def get_instance_list(self):
        ...
        media_folder_path = os.path.join(os.path.expanduser('~'), 'Downloads', 'AI-Lin-Robot', 'media')
