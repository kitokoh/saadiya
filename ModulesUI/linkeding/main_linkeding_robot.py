...
class LinkedingMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI Lin ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/aquicon-icon-18717.png'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Linkeding Robot Pro", subtitle="Analytics Overview")
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(self.tr('AI Linkeding ROBOT Pro'))
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de Linkeding Robot ? Cela retirera toutes vos instances."),
