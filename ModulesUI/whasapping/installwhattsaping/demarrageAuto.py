...
class InstallerApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("AI WA ROBOT PRO - Setup Assistant")
    ...
    def initUI(self):
        ...
        header = HeaderSection(self, title="AI WA Marketing Instances", app_name="WA ROBOT AI", slogan="AI Marketing Automation Solution ")
