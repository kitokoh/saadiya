...
class PinMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI PINTEREST ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/diving-png-4436.png'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Pinterest Robot Pro", subtitle="Analytics Overview")
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de Pinterest Robot ? Cela retirera toutes vos instances."),
