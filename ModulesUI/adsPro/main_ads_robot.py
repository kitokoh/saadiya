...
class AdsMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI AdsPro ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/robot-icons-30498.jpg'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Adspro & SEO", subtitle="Analytics Overview")
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de AdsPro Robot ? Cela retirera toutes vos instances."),
