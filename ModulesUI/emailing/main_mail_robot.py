...
class MailMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI Mail ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/newsletter-icon-37204.png'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Emailing Auto", subtitle="Analytics Overview")
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de Mail Robot ? Cela retirera toutes vos instances."),
