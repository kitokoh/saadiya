...
class MediaTable(QWidget):
 ...
 # Ajouter le menu secondaire
        ...
        self.add_media_button.setIcon(QIcon('resources/icons/robot-512.png'))  # Spécifiez le chemin de votre icône ici
        ...
        self.prev_button.setIcon(QIcon('resources/icons/robot-512.png'))  # Spécifiez le chemin de votre icône ici
        self.prev_button.clicked.connect(self.prev_page)
        pagination_layout.addWidget(self.prev_button)

        self.next_button = QPushButton('Suivant', self)
        self.next_button.setIcon(QIcon('resources/icons/robot-512.png'))  # Spécifiez le chemin de votre icône ici
