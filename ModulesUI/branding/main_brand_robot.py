...
from ModulesUI.whasapping.media_manager import MediaTable
from ModulesUI.whasapping.group_manager import GroupTable
from ModulesUI.whasapping.instances_table import InstanceTable
#from fb_robot_install import FbRobot
from ModulesUI.whasapping.wp_robot_install import WpRobot
...
class BrandMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(self.tr('AI Branding ROBOT Pro'))
        
        self.setGeometry(100, 210, 900, 600)
        self.setWindowIcon(QIcon('resources/icons/android-icon-3083.png'))  # Icône de la fenêtre
        ...
        self.instance_table = Dashboard(title="Branding Pro", subtitle="Analytics Overview")
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(self.tr('AI Brand ROBOT Pro'))
    ...
    def uninstall_instances(self):
        ...
        reply = QMessageBox.question(
            ...
            self.tr("Êtes-vous sûr de vouloir désinstaller toutes les instances de Branding Robot ? Cela retirera toutes vos instances."),
